...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center gap-1 rounded-sm border border-border bg-secondary/40 p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
